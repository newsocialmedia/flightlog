...
async function lookupFlight(flightNum, date, depTime) {
  // Calls the Vercel serverless function /api/lookup-flight.
  // Runs server-side on Vercel — no network restrictions, API key stays secure.
  const r = await fetch("/api/lookup-flight", {
    method: "POST",
