// ═══════════════════════════════════════════════════════════════════════════
// AviateSync Service Worker — v10 (network-first, self-healing)
// Cache name bumped for the FlightLog -> AviateSync rebrand: PWA clients
// serving the old bundle must invalidate their cache once, not stay on it
// indefinitely.
// ═══════════════════════════════════════════════════════════════════════════

const CACHE_NAME = "aviatesync-v10";
