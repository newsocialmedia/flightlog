  ...
  if(!c1 || !c2) return (
    <div style={{padding:"16px",borderRadius:14,background:S.panel,border:`1px solid ${S.border}`,textAlign:"center"}}>
      ...
      <div style={{fontSize:12.5,color:S.muted,lineHeight:1.5}}>
        Route map unavailable -- {!c1?dep:arr} isn't in our airport database yet.
      </div>
    </div>
  );
  ...
  return (
    <div style={{flex:1,overflowY:"auto",background:S.bg,fontFamily:"Inter,system-ui,sans-serif"}}>
      ...
      <div style={{padding:"16px 16px 32px",maxWidth:600,margin:"0 auto",display:"flex",flexDirection:"column",gap:14}}>
        ...
        <div style={{background:S.surface,border:`1px solid ${signature?.status==="fully_signed"?`${GREEN}44`:S.border}`,borderRadius:18,padding:"16px 18px"}}>
