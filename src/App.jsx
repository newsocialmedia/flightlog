...
function FlightRouteMap({dep, arr, dist, flightDateStr, flightDepTime, S, compact, hero}) {
  ...
  if(hero) return (
    <>
      ...
      {/* Radar live indicator -- top-right, clear of the back button on the left */}
      <div style={{position:"absolute",top:14,right:16,zIndex:1100,display:"flex",alignItems:"center",gap:5,background:"rgba(15,23,42,0.65)",backdropFilter:"blur(8px)",padding:"5px 10px",borderRadius:100,border:"1px solid rgba(255,255,255,0.15)"}}>
  ...
  return (
    <div style={{flex:1,overflowY:"auto",background:S.bg,fontFamily:"Inter,system-ui,sans-serif"}}>
      ...
      {/* HERO MAP -- full-bleed at the top of the page. Back/delete controls
          ...
          the page underneath. */}
      <div style={{position:"relative",width:"100%",height:260,background:"#0B1120",overflow:"hidden",flexShrink:0}}>
        {dep&&arr
      ...
      <div style={{padding:"0 16px 32px",maxWidth:600,margin:"0 auto",display:"flex",flexDirection:"column",gap:14}}>
