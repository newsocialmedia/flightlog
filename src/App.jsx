  ...
  return (
    <div style={{flex:1,overflowY:"auto",background:S.bg,fontFamily:"Inter,system-ui,sans-serif"}}>
      ...
      <div style={{padding:"16px 16px 32px",maxWidth:600,margin:"0 auto",display:"flex",flexDirection:"column",gap:14}}>
        ...
        {/* Route map */}
        {dep&&arr&&(()=>{
          const COORDS = {"ORD":[41.978,-87.907],"SCE":[40.849,-77.848],"LAX":[33.943,-118.408],"JFK":[40.640,-73.778],"SFO":[37.619,-122.375],"DFW":[32.897,-97.038],"ATL":[33.641,-84.427],"MIA":[25.796,-80.287],"MDW":[41.786,-87.742],"PHX":[33.437,-112.008],"DEN":[39.856,-104.674],"SEA":[47.449,-122.309],"BOS":[42.365,-71.010],"EWR":[40.690,-74.174],"LGA":[40.775,-73.873],"CLT":[35.214,-80.943],"LAS":[36.083,-115.152],"MCO":[28.429,-81.309],"DTW":[42.213,-83.354],"MSP":[44.883,-93.222],"FLL":[26.073,-80.151],"IAH":[29.984,-95.341],"PHL":[39.872,-75.241],"SLC":[40.789,-111.978],"BWI":[39.175,-76.669],"HOU":[29.646,-95.279],"SAN":[32.733,-117.190],"DAL":[32.847,-96.852],"PDX":[45.589,-122.598],"STL":[38.749,-90.370],"BNA":[36.125,-86.679],"AUS":[30.197,-97.666],"MCI":[39.298,-94.714],"RDU":[35.878,-78.787],"CLE":[41.412,-81.849],"CVG":[39.049,-84.667],"MEM":[35.042,-89.977],"AVP":[41.338,-75.724],"SBN":[41.709,-86.317],"DSM":[41.534,-93.663],"CHA":[35.035,-85.204],"TYS":[35.812,-83.994],"GPT":[30.407,-89.070]};
          const c1=COORDS[dep], c2=COORDS[arr];
          if(!c1||!c2) return null;
