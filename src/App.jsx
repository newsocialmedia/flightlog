  ...
  async function autoLookup(di,fi,f,day) {
    ...
    try {
      ...
      if(res.tailNumber) {
        ...
        // Save to DB first — update UI only after the write succeeds so a
        // failed save shows ✗ rather than ghost data that vanishes on refresh.
        ...
        // Clear tmp so the input reflects the freshly-saved server value
        setTmp(p=>{ const n={...p}; delete n[tk]; return n; });
