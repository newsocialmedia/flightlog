              ...
              <div style={{display:"flex",flexDirection:"column",gap:11,marginBottom:16}}>
                {mode==="signup"&&(
                  <div style={{display:"flex",gap:8}}>
                    <input
                      style={{flex:1,padding:"14px 16px",borderRadius:14,border:"1.5px solid #E2E8F0",fontSize:14,background:"#F8FAFC",color:"#0F172A",outline:"none",WebkitAppearance:"none",boxSizing:"border-box"}}
  ...
  return (
    <div style={{minHeight:"100dvh",display:"flex",alignItems:"center",justifyContent:"center",background:"#EEF1F8",padding:"24px 16px",boxSizing:"border-box"}}>
      <div style={{width:"100%",maxWidth:400,borderRadius:28,overflow:"hidden",boxShadow:"0 20px 60px rgba(0,0,0,0.15)",background:"linear-gradient(160deg,#0B1437 0%,#1D4ED8 100%)",position:"relative"}}>
        ...
        <div style={{background:"#fff",borderRadius:"28px 28px 0 0",padding:"26px 26px 30px",position:"relative",zIndex:1,boxShadow:"0 -10px 30px rgba(0,0,0,0.15)"}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:11,marginBottom:16}}>
            {mode==="signup" && (
              <div style={{display:"flex",gap:8}}>
                <input style={{flex:1,padding:"14px 16px",borderRadius:14,border:"1.5px solid #E2E8F0",fontSize:14,background:"#F8FAFC",color:"#0F172A",outline:"none",WebkitAppearance:"none",boxSizing:"border-box"}} placeholder="First name" value={firstName} onChange={e=>setFirstName(e.target.value)} autoComplete="given-name" name="firstName"/>
                <input style={{flex:1,padding:"14px 16px",borderRadius:14,border:"1.5px solid #E2E8F0",fontSize:14,background:"#F8FAFC",color:"#0F172A",outline:"none",WebkitAppearance:"none",boxSizing:"border-box"}} placeholder="Last name" value={lastName} onChange={e=>setLastName(e.target.value)} autoComplete="family-name" name="lastName"/>
              </div>
            )}
          ...
          {mode==="signup"&&(
            <div style={{fontSize:11.5,color:"#94A3B8",lineHeight:1.6,marginBottom:12}}>
              ...
              If you are under 18, you confirm you have a parent or guardian's permission to use AviateSync.
            </div>
          )}
