...
function LandingPage({onLogin, onSignup}) {
  ...
  return(
    <div style={{background:"#F8FAFC",minHeight:"100vh",fontFamily:"Inter,system-ui,sans-serif",color:"#0F172A",overflowX:"hidden",position:"relative"}}>
      ...
      {/* DEPLOY TEST BANNER — remove after confirming */}
      <div style={{position:"fixed",top:0,left:0,right:0,zIndex:99999,background:"#DC2626",color:"#fff",textAlign:"center",padding:"8px",fontSize:14,fontWeight:700}}>
        NEW BUILD v2.2 LIVE — {new Date().toISOString().slice(0,16)}
      </div>
