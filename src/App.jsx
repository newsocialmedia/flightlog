...
function SubscriptionWall({user, onSubscribed, onLogout}) {
  ...
  async function checkSubscription() {
    try {
      ...
      console.log("[Wall] token type:", isAnon?"ANON":"USER", "| status:", profile?.subscription_status, "| raw:", JSON.stringify(profile));
      ...
      console.error("[Wall] fetch error:", e.message);
      return false;
    }
  }
