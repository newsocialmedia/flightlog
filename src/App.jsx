...
const AIRPORT_TZ = {
  ...
  RST:"America/Chicago",DLH:"America/Chicago",FSD:"America/Chicago",
  BIS:"America/Chicago",FAR:"America/Chicago",GFK:"America/Chicago",
  LSE:"America/Chicago",EAU:"America/Chicago",RHI:"America/Chicago",
  ATW:"America/Chicago",GRB:"America/Chicago",CWA:"America/Chicago",
  DBQ:"America/Chicago",SUX:"America/Chicago",MHK:"America/Chicago",
  TUL:"America/Chicago",OKC:"America/Chicago",SAT:"America/Chicago",
  HOU:"America/Chicago",IAH:"America/Chicago",DAL:"America/Chicago",
  DFW:"America/Chicago",AUS:"America/Chicago",
  // Eastern Time
  LEX:"America/New_York",CMH:"America/New_York",CVG:"America/New_York",
  DAY:"America/New_York",CLE:"America/New_York",PIT:"America/New_York",
  BUF:"America/New_York",JFK:"America/New_York",LGA:"America/New_York",
  EWR:"America/New_York",BOS:"America/New_York",DCA:"America/New_York",
  IAD:"America/New_York",ATL:"America/New_York",CLT:"America/New_York",
  MIA:"America/New_York",MCO:"America/New_York",TPA:"America/New_York",
  RDU:"America/New_York",BNA:"America/New_York",MEM:"America/New_York",
  SYR:"America/New_York",ALB:"America/New_York",ROC:"America/New_York",
  BTV:"America/New_York",PWM:"America/New_York",BGR:"America/New_York",
  ABE:"America/New_York",AVP:"America/New_York",IPT:"America/New_York",
  ELM:"America/New_York",ITH:"America/New_York",BGM:"America/New_York",
  SWF:"America/New_York",HPN:"America/New_York",ACK:"America/New_York",
  MVY:"America/New_York",PVD:"America/New_York",ORF:"America/New_York",
  RIC:"America/New_York",SBY:"America/New_York",CHO:"America/New_York",
  LYH:"America/New_York",ROA:"America/New_York",PHF:"America/New_York",
  GSO:"America/New_York",GSP:"America/New_York",AVL:"America/New_York",
  CAE:"America/New_York",CHS:"America/New_York",SAV:"America/New_York",
  JAX:"America/New_York",PNS:"America/New_York",VPS:"America/New_York",
  TLH:"America/New_York",GNV:"America/New_York",DAB:"America/New_York",
  MLB:"America/New_York",RSW:"America/New_York",FLL:"America/New_York",
  PBI:"America/New_York",EYW:"America/New_York",AGS:"America/New_York",
  BHM:"America/New_York",HSV:"America/New_York",MOB:"America/New_York",
  MSY:"America/Chicago",BTR:"America/Chicago",LFT:"America/Chicago",
  DTW:"America/Detroit",IND:"America/Indiana/Indianapolis",
  EVV:"America/Indiana/Indianapolis",SBN:"America/Indiana/Indianapolis",
  FWA:"America/Indiana/Indianapolis",
  MDT:"America/New_York",HTS:"America/New_York",CRW:"America/New_York",
  TVC:"America/Detroit",MBS:"America/Detroit",FNT:"America/Detroit",
  GRR:"America/Detroit",LAN:"America/Detroit",AZO:"America/Detroit",
  MKG:"America/Detroit",PLN:"America/Detroit",
  // Mountain Time
  DEN:"America/Denver",SLC:"America/Denver",ABQ:"America/Denver",
  COS:"America/Denver",GJT:"America/Denver",DRO:"America/Denver",
  ASE:"America/Denver",EGE:"America/Denver",GUC:"America/Denver",
  MTJ:"America/Denver",PUB:"America/Denver",LAR:"America/Denver",
  BIL:"America/Denver",BZN:"America/Denver",GTF:"America/Denver",
  HLN:"America/Denver",MSO:"America/Denver",FCA:"America/Denver",
  GPI:"America/Denver",JAC:"America/Denver",CPR:"America/Denver",
  RKS:"America/Denver",CYS:"America/Denver",
  // Arizona (no DST)
  PHX:"America/Phoenix",TUS:"America/Phoenix",FLG:"America/Phoenix",
  YUM:"America/Phoenix",GCN:"America/Phoenix",
  // Pacific Time
  ...
  BUR:"America/Los_Angeles",ONT:"America/Los_Angeles",LGB:"America/Los_Angeles",
  SNA:"America/Los_Angeles",PSP:"America/Los_Angeles",SBA:"America/Los_Angeles",
  FAT:"America/Los_Angeles",RDD:"America/Los_Angeles",ACV:"America/Los_Angeles",
  MRY:"America/Los_Angeles",SLO:"America/Los_Angeles",RNO:"America/Los_Angeles",
  BOI:"America/Los_Angeles",TWF:"America/Los_Angeles",IDA:"America/Los_Angeles",
  PIH:"America/Los_Angeles",Sun:"America/Los_Angeles",
  // Alaska / Hawaii
  ANC:"America/Anchorage",FAI:"America/Anchorage",JNU:"America/Anchorage",
  KTN:"America/Anchorage",HNL:"Pacific/Honolulu",OGG:"Pacific/Honolulu",
  KOA:"Pacific/Honolulu",LIH:"Pacific/Honolulu",ITO:"Pacific/Honolulu",
};
...
function getAirportUtcOffsetMins(airportCode) {
  ...
  try {
    // Get the UTC offset for this timezone right now (DST-aware).
    // We format a known UTC timestamp in the target timezone and compare
    // the resulting hour/minute to the UTC hour/minute.
    const now = new Date();
    // Use Intl to get hours and minutes in the target timezone
    ...
    let offset = (h * 60 + m) - (utcH * 60 + utcM);
    // Normalize across midnight boundary
