...
} = `${SUPA_URL}/functions/v1/flight-briefing`;
            ...
            <div style={{marginBottom:10,padding:20,borderRadius:14,background:`linear-gradient(135deg,${C.teal},${C.tealDim})`,position:"relative",overflow:"visible"}}>
              ...
              <button
                ...
                style={{
                  ...
                  background:loading==="annual"?"rgba(255,255,255,0.8)":"#fff",
              ...
              >
                {loading==="annual"
                  ?<span style={{display:"flex",alignItems:"center",justifyContent:"center",gap:8}}><span className="spinner">loading</span>Processing...</span>
            ...
            <div className="card" style={{marginBottom:14,opacity:0.85}}>
              ...
              <button
                ...
                style={{
                  ...
                  background:loading==="monthly"?C.panel:"none",
                  border:`1.5px solid ${C.border}`,
                  color:loading==="monthly"?C.muted:C.silver,
