      ...
      <div className="auth-card">
        ...
        {mode==="signup"&&(
          <div style={{fontSize:11.5,color:C.muted,lineHeight:1.6,marginBottom:12}}>
            ...
            <span onClick={()=>onNavigateLegal?.("terms")} style={{color:C.teal,fontWeight:600,cursor:"pointer",textDecoration:"underline"}}>Terms of Service</span>
            {" "}and{" "}
            <span onClick={()=>onNavigateLegal?.("privacy")} style={{color:C.teal,fontWeight:600,cursor:"pointer",textDecoration:"underline"}}>Privacy Policy</span>.
