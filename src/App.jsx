...
@media(max-width:768px){
  ...
  .mobile-tabbar{display:flex;flex-direction:column;flex-shrink:0}
            ...
            <table style={{width:"100%",borderCollapse:"collapse",fontSize:13}}>
              ...
              <tbody>
                {(()=>{
                  ...
                  // Only show flights that have already happened (past + today)
                  const pastRows = rows.filter(r=>r.dateStr<=todayStr);
                  ...
                  return pastRows.slice(0,5).map(({f,t,dateStr,tk},idx)=>(
