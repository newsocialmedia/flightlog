          ...
          {user.role!=="admin"&&user.subscription_status!=="active"&&user.subscription_status!=="past_due"?(
            <div style={{flex:1,overflowY:"auto",display:"flex",flexDirection:"column"}}>
              ...
              <div style={{padding:"16px 20px",borderBottom:`1px solid ${C.border}`,background:C.surface,display:"flex",alignItems:"center",justifyContent:"space-between",flexShrink:0}}>
                <div style={{fontSize:18,fontWeight:800,color:C.teal,letterSpacing:"-.5px"}}>Flight<span style={{color:C.ink}}>Log</span></div>
                <button onClick={handleLogout} style={{fontSize:12,color:C.muted,background:"none",border:"none",cursor:"pointer"}}>Sign out</button>
              </div>
              <div style={{flex:1,overflowY:"auto",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"flex-start",padding:"24px 16px"}}>
                ...
                <div style={{textAlign:"center",marginBottom:24,maxWidth:360}}>
                  ...
                  <div style={{fontSize:14,color:C.muted,lineHeight:1.6}}>
                    Your account is ready. Subscribe to unlock your logbook, auto-sync, and all FlightLog features.
                  </div>
                </div>
                {/* Features preview */}
                <div style={{width:"100%",maxWidth:400,marginBottom:24}}>
                  {[
                    {icon:"📄",text:"AI roster parsing — any airline PDF"},
                    {icon:"✈",text:"Auto tail number & block time sync via FlightAware"},
                    {icon:"📊",text:"FAR 61.57 & 117 currency tracking"},
                    {icon:"📋",text:"Jeppesen & ASA export formats"},
                    {icon:"🗺️",text:"Route maps with live weather radar"},
                    {icon:"🤖",text:"AI flight briefings"},
                  ].map(({icon,text})=>(
