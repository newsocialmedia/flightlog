          ...
          return(
            <div style={{display:"grid",gridTemplateColumns:"1fr",gap:14,marginBottom:20}}>
              ...
              <div style={{background:`linear-gradient(135deg,${S.blueDim},${S.blue})`,borderRadius:24,padding:"20px 22px",color:"#fff",boxShadow:`0 8px 32px ${S.blue}25`}}>
                ...
                {miniBriefing?(
                  <div style={{background:"rgba(255,255,255,0.12)",backdropFilter:"blur(8px)",borderRadius:14,padding:"12px 14px",border:"1px solid rgba(255,255,255,0.2)",fontSize:12,lineHeight:1.7,color:"rgba(255,255,255,0.9)",marginBottom:12,maxHeight:120,overflowY:"auto",overscrollBehaviorY:"contain"}}>
                    {miniBriefing}
                  </div>
                ):(
...
function LogbookHubPage({user, rosters, tails, onTailSaved, onDeleteRoster, onRosterUpdated, onOpenFlight, pendingFlight, onPendingFlightConsumed, setPage, initialTab, pushFlightOpenHistory}) {
  ...
  return(
    <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden",background:S.bg,fontFamily:"Inter,system-ui,sans-serif"}}>
     ...
     <div style={{flex:1,overflowY:"auto",overscrollBehaviorY:"contain",WebkitOverflowScrolling:"touch",display:"flex",flexDirection:"column"}}>
      {/* Top label */}
